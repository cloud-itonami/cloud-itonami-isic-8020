# Operator Quickstart — Community Security Systems Service Operations

Shortest path from clone to a verified local dry-run for **ISIC 8020** (`cloud-itonami-isic-8020`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8020.git
cd cloud-itonami-isic-8020
```
...
- Blueprint governor key: `security-systems-governor`
- Likely source path: `src/**/security-systems-governor.cljc`
